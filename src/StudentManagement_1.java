...
public class StudentManagement_1 {
    ...
    private static void displayMainMenu() {
        String[] options = {"Create New Student Record File", "Display List of .txt Files", "Retrieve Student Records from File", "Change Directory", "Exit"};
        int choice;

        do {
            choice = JOptionPane.showOptionDialog(null, "Student Management System", "Main Menu", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);

            switch (choice) {
                case 0:
                    createStudentRecordFile(); break;
                case 1:
                    displayTxtFiles(); break;
                case 2:
                    retrieveStudentRecords(); break;
                case 3:
                    changeDirectory(); break;
                case 4:
                    JOptionPane.showMessageDialog(null, "Exiting program. Goodbye!"); System.exit(0); break;
                default:
